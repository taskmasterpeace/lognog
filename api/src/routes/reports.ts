...
router.post('/generate', async (req: Request, res: Response) => {
  try {
    const { query, format = 'html', title = 'Spunk Report', timeRange } = req.body;
...
<body>
  <div class="container">
    <div class="header">
      ...
      <p>Generated by Spunk Log Analytics Platform</p>
      <div class="meta">
        <div class="meta-item">
    ...
    <div class="footer">
      Spunk - Open Source Log Analytics | ${escapeHtml(generatedAt)}
    </div>
  </div>
</body>
</html>`;
