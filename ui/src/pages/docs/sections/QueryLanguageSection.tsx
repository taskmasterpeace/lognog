      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Key Features</h3>
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
                <ChevronRight className="w-4 h-4 text-honey-500 mt-0.5 flex-shrink-0" />
                <span className="text-nog-600 dark:text-nog-300">Pipe-based syntax for intuitive data flow</span>
              </li>
              <li className="flex items-start gap-2">
                <ChevronRight className="w-4 h-4 text-honey-500 mt-0.5 flex-shrink-0" />
                <span className="text-nog-600 dark:text-nog-300">Fast compilation (&lt;3ms parse overhead)</span>
              </li>
              <li className="flex items-start gap-2">
                <ChevronRight className="w-4 h-4 text-honey-500 mt-0.5 flex-shrink-0" />
              ...
              <li className="flex items-start gap-2">
                <ChevronRight className="w-4 h-4 text-honey-500 mt-0.5 flex-shrink-0" />
                <span className="text-nog-600 dark:text-nog-300">Smart optimization with proper indexes</span>
              </li>
            </ul>
          </div>

          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Your First Query</h3>
...
search host=router severity>=warning`} />
      ...
      <section>
        <h2 className="text-xl font-bold text-nog-900 dark:text-nog-100 mb-4">Standard Log Fields</h2>
...
function BasicSearching() {
  return (
    <div className="space-y-6">
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Field-Value Searches</h2>
        <p className="text-nog-600 dark:text-nog-400 mb-4">
...
search user=admin`} />
      ...
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Wildcards</h2>
        <p className="text-nog-600 dark:text-nog-400 mb-4">
...
search host=*              # Match all (any value)`} />
      ...
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Comparison Operators</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Numeric Comparison</h3>
...
search severity>=warning`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Equality</h3>
...
search host!=localhost`} />
        ...
        <div className="card p-4 bg-honey-50 border-honey-200 dark:bg-honey-900/20 dark:border-honey-800">
          <p className="text-honey-800 dark:text-honey-300 text-sm">
            <strong>Tip:</strong> You can use severity names like <code className="bg-honey-100 dark:bg-honey-900 px-2 py-0.5 rounded">warning</code>, <code className="bg-honey-100 dark:bg-honey-900 px-2 py-0.5 rounded">error</code>, <code className="bg-honey-100 dark:bg-honey-900 px-2 py-0.5 rounded">debug</code> instead of numbers!
          </p>
        </div>
      </section>

      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Contains/Regex (~)</h2>
        <p className="text-nog-600 dark:text-nog-400 mb-4">
...
search app_name~"web"                     # Contains "web"`} />
      ...
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Multiple Conditions</h2>

        <div className="space-y-4">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Implicit AND</h3>
...
# Returns logs from router with severity warning or higher`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">OR Logic</h3>
            <CodeBlock code={`search severity=0 OR severity=1 OR severity=2
search host=web01 OR host=web02`} />
          </div>

          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">NOT Logic</h3>
            <CodeBlock code={`search NOT severity=7                    # Exclude debug logs
search host=router NOT message~"keepalive"`} />
          </div>

          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Complex Logic with Parentheses</h3>
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="card p-4 dark:bg-nog-800">
          ...
          <p className="text-sm text-nog-600 dark:text-nog-400 mb-3">Additional filtering after initial search</p>
...
search * | where severity<=3`} />
        ...
        <div className="card p-4 dark:bg-nog-800">
          ...
          <p className="text-sm text-nog-600 dark:text-nog-400 mb-3">Select specific fields to display</p>
...
search * | table timestamp severity app_name`} />
        ...
        <div className="card p-4 dark:bg-nog-800">
          ...
          <p className="text-sm text-nog-600 dark:text-nog-400 mb-3">Include or exclude fields</p>
...
search * | fields - raw structured_data`} />
        ...
        <div className="card p-4 dark:bg-nog-800">
          ...
          <p className="text-sm text-nog-600 dark:text-nog-400 mb-3">Rename fields in output</p>
...
search * | rename hostname as host, app_name as app`} />
        ...
        <div className="card p-4 dark:bg-nog-800">
          ...
          <p className="text-sm text-nog-600 dark:text-nog-400 mb-3">Remove duplicates based on fields</p>
...
search * | dedup hostname app_name`} />
        ...
        <div className="card p-4 dark:bg-nog-800">
          ...
          <p className="text-sm text-nog-600 dark:text-nog-400 mb-3">Order results by fields</p>
...
search * | sort asc severity, desc hostname`} />
        ...
        <div className="card p-4 dark:bg-nog-800">
          ...
          <p className="text-sm text-nog-600 dark:text-nog-400 mb-3">Limit number of results</p>
...
function AggregationsStats() {
  return (
    <div className="space-y-6">
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Basic Aggregations</h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">count</h3>
...
search * | stats count as total`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">sum / avg / min / max</h3>
...
search * | stats min(timestamp), max(timestamp)`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">dc (distinct count)</h3>
...
search * | stats dc(source_ip) by hostname`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">values / list</h3>
...
search * | stats list(message) by hostname`} />
      ...
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Advanced Aggregations</h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">earliest / latest</h3>
            <CodeBlock code={`search * | stats earliest(message)
search * | stats latest(message)`} />
          </div>

          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">median / mode</h3>
            <CodeBlock code={`search * | stats median(response_time)
search * | stats mode(severity)`} />
          </div>

          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">stddev / variance</h3>
            <CodeBlock code={`search * | stats stddev(response_time)
search * | stats variance(bytes)`} />
          </div>

          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">range</h3>
...
search * | stats range(bytes) by hostname`} />
      ...
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Percentiles</h2>
        <p className="text-nog-600 dark:text-nog-400 mb-4">
  ...
  by endpoint`} />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
          {['p50', 'p90', 'p95', 'p99'].map((p) => (
            <div key={p} className="card p-3 dark:bg-nog-800 text-center">
              <code className="code text-honey-600 dark:text-honey-400">{p}(field)</code>
              <p className="text-xs text-nog-500 dark:text-nog-400 mt-1">{p.substring(1)}th percentile</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Multiple Aggregations & Grouping</h2>
...
function EvalFunctions() {
  return (
    <div className="space-y-6">
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Math Functions</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Basic Math</h3>
...
eval ceiled=ceil(3.1)`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Advanced Math</h3>
...
eval exp_value=exp(value)`} />
      ...
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">String Functions</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Basic String Operations</h3>
...
eval trimmed=trim(message)`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Advanced String Operations</h3>
...
eval full_name=concat(first, " ", last)`} />
      ...
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Conditional Functions</h2>
        <div className="space-y-4">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">if</h3>
            <p className="text-sm text-nog-600 dark:text-nog-400 mb-2">Conditional expression with true/false branches</p>
            <CodeBlock code={`eval level=if(severity <= 3, "high", "low")
eval status=if(code >= 200 AND code < 300, "success", "failure")`} />
          </div>

          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">coalesce</h3>
            <p className="text-sm text-nog-600 dark:text-nog-400 mb-2">Return first non-null value</p>
            <CodeBlock code={`eval host=coalesce(hostname, source, "unknown")
eval app=coalesce(app_name, program, "default")`} />
          </div>

          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">case</h3>
            <p className="text-sm text-nog-600 dark:text-nog-400 mb-2">Multi-way conditional</p>
  ...
  "info"
      ...
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Practical Examples</h2>
        <div className="space-y-4">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Calculate Response Time Category</h3>
            <CodeBlock code={`search app_name=api
  ...
  | stats count by category`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Extract Domain from Email</h3>
  ...
  | stats count by domain`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Calculate Error Rate</h3>
...
search * | rare 5 app_name`} />
        ...
        <div className="card p-4 dark:bg-nog-800">
          ...
          <p className="text-sm text-nog-600 dark:text-nog-400 mb-3">Create time buckets or numeric bins</p>
...
search * | bin span=100 bytes`} />
        ...
        <div className="card p-4 dark:bg-nog-800">
          ...
          <p className="text-sm text-nog-600 dark:text-nog-400 mb-3">Aggregate data over time buckets</p>
...
search * | timechart span=1h count by hostname`} />
        ...
        <div className="card p-4 dark:bg-nog-800 md:col-span-2">
          ...
          <p className="text-sm text-nog-600 dark:text-nog-400 mb-3">Extract fields using regular expressions with named groups</p>
...
function UseCaseExamples() {
  return (
    <div className="space-y-6">
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Security Monitoring</h2>
        <div className="space-y-4">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Failed Login Attempts</h3>
  ...
  | limit 20`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Brute Force Detection</h3>
            <CodeBlock code={`search app_name=sshd message~"Failed"
  ...
  | sort desc count`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Privilege Escalation</h3>
  ...
  | sort desc timestamp`} />
      ...
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Performance Analysis</h2>
        <div className="space-y-4">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Slow API Endpoints</h3>
            <CodeBlock code={`search app_name=api
  | stats p50(response_time) as median,
          p95(response_time) as p95,
          p99(response_time) as p99,
  ...
  | sort desc p95`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Response Time Distribution</h3>
            <CodeBlock code={`search app_name=api
  | eval bucket=case(
      response_time,
      100, "0-100ms",
  ...
  | stats count by bucket`} />
      ...
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Error Tracking</h2>
        <div className="space-y-4">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Error Rate by Application</h3>
  ...
  | sort desc error_rate`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Unique Error Messages</h3>
            <CodeBlock code={`search severity<=3
  ...
  by app_name`} />
      ...
      <section>
        <h2 className="text-2xl font-bold text-nog-900 dark:text-nog-100 mb-4">Infrastructure Monitoring</h2>
        <div className="space-y-4">
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Network Traffic Analysis</h3>
  ...
  | limit 50`} />
          ...
          <div className="card p-4 dark:bg-nog-800">
            <h3 className="font-semibold text-nog-900 dark:text-nog-100 mb-2">Active Users</h3>
...
export default function QueryLanguageSection() {
