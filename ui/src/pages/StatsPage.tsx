  ...
  return (
    <div className="card p-4 sm:p-5">
      <div className="flex items-start justify-between">
        ...
        {trend && (
          <span className="flex items-center gap-1 text-[10px] sm:text-xs font-medium text-honey-600 bg-honey-50 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full">
      ...
      <div className="mt-3 sm:mt-4">
        <p className="text-2xl sm:text-3xl font-bold text-nog-900 dark:text-nog-100">{typeof value === 'number' ? value.toLocaleString() : value}</p>
    ...
    <div className="min-h-full bg-nog-50 dark:bg-nog-900">
      ...
      <div className="bg-white dark:bg-nog-800 border-b border-nog-200 dark:border-nog-700 shadow-sm">
        <div className="p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-nog-900 dark:text-nog-100">Analytics</h1>
              <p className="text-nog-500 dark:text-nog-400 text-sm mt-1 hidden sm:block">Real-time log metrics and insights</p>
            </div>
            <div className="flex items-center gap-2 text-xs sm:text-sm text-nog-500 dark:text-nog-400">
              <Zap className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-honey-500" />
          ...
          {/* Tab Navigation */}
          <div className="flex gap-1 mt-4 border-b border-nog-200 dark:border-nog-700 -mb-px">
            <button
              onClick={() => setActiveTab('analytics')}
              className={`flex items-center gap-2 px-4 py-2 text-sm font-medium border-b-2 transition-colors ${
                activeTab === 'analytics'
                  ? 'border-honey-500 text-honey-600 dark:text-honey-400'
                  : 'border-transparent text-nog-500 dark:text-nog-400 hover:text-nog-700 dark:hover:text-nog-300'
              }`}
            >
      ...
      {activeTab === 'analytics' && (statsLoading || timeSeriesLoading) && (
        <div className="flex flex-col items-center justify-center h-64">
          ...
          <p className="text-nog-600 dark:text-nog-400">Loading analytics...</p>
        </div>
      )}
      ...
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="card p-4 sm:p-5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 sm:mb-4 gap-2">
              <div>
                <h3 className="font-semibold text-nog-900 dark:text-nog-100 text-sm sm:text-base">Log Volume</h3>
                <p className="text-xs sm:text-sm text-nog-500 dark:text-nog-400">Events per hour (last 24h)</p>
              </div>
              <div className="flex items-center gap-3 sm:gap-4 text-[10px] sm:text-xs">
                <span className="flex items-center gap-1.5">
                  <span className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-honey-500"></span>
                  Total
                </span>
                <span className="flex items-center gap-1.5">
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-3 sm:mt-4">
              {severityData.slice(0, 6).map((entry) => (
                <button
                  ...
                  className="flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-xs text-nog-600 dark:text-nog-400 hover:text-nog-900 dark:hover:text-nog-200 cursor-pointer"
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="card p-4 sm:p-5">
            <div className="mb-3 sm:mb-4">
              <h3 className="font-semibold text-nog-900 dark:text-nog-100 text-sm sm:text-base">Top Hosts</h3>
              <p className="text-xs sm:text-sm text-nog-500 dark:text-nog-400">Click to search by host</p>
            </div>
            <BarChart
          ...
          <div className="card p-4 sm:p-5">
            <div className="mb-3 sm:mb-4">
              <h3 className="font-semibold text-nog-900 dark:text-nog-100 text-sm sm:text-base">Top Applications</h3>
              <p className="text-xs sm:text-sm text-nog-500 dark:text-nog-400">Click to search by app</p>
            </div>
            <BarChart
