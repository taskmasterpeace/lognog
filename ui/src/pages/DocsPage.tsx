  ...
  return (
    <div className="space-y-8">
      <section>
        ...
        <div className="card p-4 bg-gradient-to-r from-purple-50 to-blue-50 border-purple-200 dark:from-purple-900/20 dark:to-blue-900/20 dark:border-purple-800 mb-6">
