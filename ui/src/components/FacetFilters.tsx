      ...
      <div className="px-4 py-3 border-b border-nog-200 dark:border-nog-700 bg-nog-50 dark:bg-nog-900">
        <div className="flex items-center justify-between">
          ...
          {totalSelected > 0 && (
            <button
              onClick={clearAll}
              className="flex items-center gap-1 text-xs font-medium text-honey-600 hover:text-honey-700 dark:text-honey-400 dark:hover:text-honey-300 transition-all duration-200 hover:scale-105 active:scale-95 animate-fade-in"
            >
              <X className="w-3 h-3" />
              Clear All
            </button>
        ...
        {totalSelected > 0 && (
          <p className="text-xs text-nog-500 dark:text-nog-400 mt-1 animate-fade-in">
            ...
            return (
              <div key={facet.field} className="border-b border-nog-200 dark:border-nog-700">
                ...
                >
                  ...
                  {selectedCount > 0 && (
                    <span className="px-2 py-0.5 bg-honey-100 dark:bg-honey-900/30 text-honey-700 dark:text-honey-400 text-xs font-medium rounded-full animate-scale-in">
                      {selectedCount}
                    </span>
                  )}
                </button>
                          ...
                          return (
                            ...
                            >
                              <input
                                ...
                                className="w-4 h-4 text-honey-600 border-nog-300 rounded focus:ring-honey-500 focus:ring-offset-0 cursor-pointer"
                              />
                              <div className="flex-1 min-w-0 flex items-center justify-between gap-2">
                                {facet.field === 'severity' ? (
                                  ...
                                  <span className="text-sm text-nog-700 dark:text-nog-300 truncate" title={displayValue}>
                                    {displayValue}
                                  </span>
                                )}
                                <span className="text-xs text-nog-500 dark:text-nog-400 font-medium tabular-nums flex-shrink-0">
