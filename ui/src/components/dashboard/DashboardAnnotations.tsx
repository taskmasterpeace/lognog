...
export function DashboardAnnotations({
  ...
  return (
    <div className="px-4 py-2 border-b border-nog-200 dark:border-nog-700 bg-honey-50/50 dark:bg-honey-900/10">
      <div className="flex items-center justify-between mb-2">
        <span className="text-sm font-medium text-nog-600 dark:text-nog-400 flex items-center gap-1">
        ...
        {editMode && onAdd && (
          <button
            ...
            className="text-sm text-honey-600 hover:text-honey-700 dark:text-honey-400"
          >
            + Add
          </button>
        )}
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-2 py-1 rounded text-sm hover:bg-white dark:hover:bg-nog-700"
        style={{ borderLeft: `3px solid ${annotation.color}` }}
      >
        <span className="font-medium text-nog-700 dark:text-nog-300">
          {annotation.title}
        </span>
        <span className="text-xs text-nog-500">
      ...
      {showDetails && (
        <>
          ...
          <div className="absolute top-full left-0 mt-1 z-20 w-64 bg-white dark:bg-nog-800 border border-nog-200 dark:border-nog-600 rounded-lg shadow-lg p-3">
                ...
                {['#3B82F6', '#22C55E', '#F59E0B', '#EF4444', '#8B5CF6'].map((c) => (
                  <button
                    ...
                    className={`w-8 h-8 rounded-full border-2 ${
                      color === c ? 'border-nog-900 dark:border-white' : 'border-transparent'
                    }`}
